// NCAA API 
function  onloadCall() {
    alert("Congratulations! UCONN You're 2023 NCAA CHAMPIONS!")
    let popup = document.getElementById("winnerspopup");
...
let ncaaWest = [
    ...
    // alert(ncaaWest[`Congratulations UConn, You're 2023 NCAA CHAMPIONS!" `]),
    {
        teamName: "Iona",
        seedNumber: 13,
        finalScore: 63,
